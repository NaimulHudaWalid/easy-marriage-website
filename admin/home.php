...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-12 col-sm-6 col-md-3">
      <div class="info-box mb-3">
        <div class="info-box-content" style="background-image: linear-gradient(to right top, #1d3962, #006c90, #00a0a4, #6dd1a1, #defb9d); border-radius: 11px;">
          <span class="info-box-text" style="font-size:24px; text-align:center; color:#fff;">PRODUCT ORDER</span>
          <span class="info-box-number" style="font-size:24px; text-align:center; color:#fff;"><?php echo $conn->query("SELECT * FROM orders")->num_rows; ?></span>
        </div>
      </div>
    </div>
